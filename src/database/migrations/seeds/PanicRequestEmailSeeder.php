...
class PanicRequestEmailSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        if ($template) {
            ...
            <div style="margin: 0 auto; max-width: 640px; padding: 15px; text-align: center;"><h3 style="padding: 11px 16px; color: #fff; background-color: #ff3f05; text-decoration: none; border-radius: 5px;"> <span style="font-size: 20px; letter-spacing: 0.5px; font-weight: bold; font-family: " Roboto", sans-serif;">' . trans('panic::emailText') . '</span> </a></div>
          </div>
            ');
            $template->save();
        }
