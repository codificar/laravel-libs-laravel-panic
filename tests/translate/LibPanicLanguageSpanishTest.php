...
// to run test: sail artisan test --filter LibPanicLanguageSpanishTest
class LibPanicLanguageSpanishTest extends TestCase
{
    /**
    ...
    // Caminhos para os arquivos de array em diferentes diretórios
	{
        ...
        $path = base_path() . '/vendor/codificar/panic/src/resources/lang';
